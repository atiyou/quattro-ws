...
Vagrant.configure("2") do |config|
  ...
  config.vm.box_url = "http://nexus.integration.linky.distribution.edf.fr/content/sites/DLP-SITE/vagrant/boxes/enedis/rhel-6.6-n3.json"
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    #ls -ltr /vagrant_data
    #sudo rpm -i /vagrant_data/epel-release-latest-6.noarch.rpm
